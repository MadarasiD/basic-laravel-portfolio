                        ...
                        <div class="card-body">
                            <form action="{{route('admin.about.update',1)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea name="description" class="form-control summernote" style="height: 100px">{!! $about->description !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Önéletrajz</label>
                                    <div class="col-sm-12 col-md-7">
