...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Lábléc kapcsolat információ</h1>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Lábléc kapcsolat információ módosítása</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.footer-contact-info.update', 1) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Lakhely</label>
