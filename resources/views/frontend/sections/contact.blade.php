        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3 text-center">
                <div class="section-title">
                    <h3 class="title">{{$contactSetting->title}}</h3>
                    <div class="desc">
                        <p>{!! $contactSetting->sub_title !!}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                ...
                <form class="contact-form" id="contact-form">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-box">
                                <textarea class="input-box" id="form-message" placeholder="Üzenet..." cols="30" rows="4" name="message"></textarea>
                                <label for="form-message" class="icon lb-message"><i class="fal fa-edit"></i></label>
                            </div>
                        </div>
                        <div class="terms">
                            <label>
                                <input type="checkbox" name="terms" required> Elfogadom az <a href="{{ url('/terms') }}" target="_blank">Adatkezelési tájékoztatót</a>
                            </label>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-box">
                                <button class="button-primary mouse-dir" id="submit_btn" type="submit">Küldés most <span
        ...
        $(document).on('submit', '#contact-form', function(e){
            ...
            $.ajax({
                    ...
                    beforeSend: function(){
                        ...
                        $('#submit_btn').text('Küldés folyamatban...');
                    },
