                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Banner szakasz frissítése</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.hero.update', 1) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Alcím</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Gomb
                                        szövege</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Gomb url</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                @if ($hero->image)
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Háttérkép /
                                        Video előnézet</label>
                                    <div class="col-sm-12 col-md-7">    
                                        <div class="custom-file">
                                            <iframe class="w-25" src="{{$hero->image}}" alt=""></iframe>
                                        </div>
                                    </div>
                                </div>
                                @endif
